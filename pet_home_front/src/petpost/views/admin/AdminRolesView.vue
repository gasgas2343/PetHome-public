...
async function selectRole(role) {
  ...
  try {
    ...
    console.log('角色權限 response:', response.data)
    console.log('角色權限 data:', response.data.data)
    console.log('角色權限 permissions:', response.data.data?.permissions)
...
<template>
  <div class="role-permission-page">
    <div class="page-head">
      ...
      <button class="refresh-btn" type="button" @click="loadInitialData">重新整理</button>
    </div>
